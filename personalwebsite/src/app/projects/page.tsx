...
export default function ProjectsPage() {
  return (
    <div className="bg-gradient-to-br from-gray-900 to-black animated-gradient">
    <section id="projects" className="py-12 mx-auto max-w-6xl">
      <Link href="/" className="bg-orange-500 text-white font-bold py-3 px-6 mb-4 rounded-lg hover:bg-orange-600 transition-all duration-300">
          {'< Back'}
      </Link>
      <h2 className="text-5xl font-bold mb-6 mt-6">All Projects</h2>
