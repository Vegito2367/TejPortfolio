            ...
            <div className="container mx-auto flex flex-col md:flex-row items-center justify-between space-y-12 md:space-y-0 md:space-x-16">
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl lg:text-3xl text-gray-300 leading-relaxed max-w-prose">
                        A <strong>curious builder</strong> &amp; <strong>data-driven researcher</strong> pursuing my B.S. in Computer Science with a Mathematics minor at the University of Kansas. I solve problems at the intersection of software engineering, AI, and scientific discovery. Checking again for webhook
                    </p>
